...
// Drop this file into your React project (e.g. src/GravitationalVortex.jsx)
...
function eyeShift(tiltRad, orbitRad, dist, funnel, focal) {
...
const VORTEX_DEFAULTS = { twist: 13, funnel: 32 }
 
/* ---------------------------------------------------------------- component */
 
export default function GravitationalVortex(props) {
    const {
        background = "#000000",
        backgroundColor,
        baseColor = "#04FF3F",
